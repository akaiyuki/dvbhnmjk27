...
//                finish();
    ...
    public void showColorCalendar(BaseActivity baseActivity) {
        final Dialog dialog = new Dialog(baseActivity);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.dialog_color_calendar);

//        RecyclerView mRecyclerViewRegular;
//        RecyclerView mRecyclerViewSpecial;
//
//        mRecyclerViewRegular = (RecyclerView) dialog.findViewById(R.id.listview_color_regular);
//        mRecyclerViewSpecial = (RecyclerView) dialog.findViewById(R.id.listview_color_special);
//
//        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DesignBoxActivity.INSTANCE);
//        linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
//        mRecyclerViewRegular.setLayoutManager(linearLayoutManager);
...
//        mRecyclerViewSpecial.setAdapter(mAdapterSpecial);
        ...
        RelativeLayout buttonDone = (RelativeLayout) dialog.findViewById(R.id.buttonDone);
