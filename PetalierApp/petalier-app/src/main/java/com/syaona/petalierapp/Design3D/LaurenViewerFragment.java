...
/**
 * Created by smartwavedev on 5/31/16.
 */
public class LaurenViewerFragment extends BaseViewerFragment implements View.OnTouchListener {

    public static String TAG = "LaurenViewerFragment";
    private ArrayList<String> selectedColor = new ArrayList<>();
    public static LaurenViewerFragment INSTANCE = null;
                    ...
                    if (obj.getName().equalsIgnoreCase("box")) {
                        ...
                        if (!obj.getName().equalsIgnoreCase("box")){
                            ...
                            for(int x=0; x<30; x++) {
                                ...
                                if (x == 1){
                                    c.setPosition(2.4, -0.3, 0.4);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 2){
                                    c.setPosition(3.7, -0.3, -0.2);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 3){
                                    c.setPosition(4.6, -0.3, -1.4);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 4){
                                    c.setPosition(5.0, -0.3, -2.7);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 5){
                                    c.setPosition(4.8, -0.3, -4.0);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 6){
                                    c.setPosition(4.3, -0.3, -5.2);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 7){
                                    c.setPosition(3.2, -0.3, -6.0);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 8){
                                    c.setPosition(1.9, -0.3, -6.2);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 9){
                                    c.setPosition(0.6, -0.3, -6.0);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 10){
                                    c.setPosition(-0.7, -0.3, -5.5);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 11){
                                    c.setPosition(-1.7, -0.3, -4.5);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 12){
                                    c.setPosition(-1.9, -0.3, -3.1);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 13){
                                    c.setPosition(-1.8, -0.3, -1.8);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 14){
                                    c.setPosition(-1.2, -0.3, -0.6);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 15){
                                    c.setPosition(-0.3, -0.3, 0.3);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 16){
                                    c.setPosition(0.3, -0.3, -1.0);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 17){
                                    c.setPosition(1.7, -0.3, -0.7);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 18){
                                    c.setPosition(3.0, -0.3, -1.3);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 19){
                                    c.setPosition(3.7, -0.3, -2.5);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 20){
                                    c.setPosition(3.5, -0.3, -3.8);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x ==21){
                                    c.setPosition(2.6, -0.3, -4.8);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 22){
                                    c.setPosition(1.3, -0.3, -4.9);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 23){
                                    c.setPosition(-0.1, -0.3, -4.4);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 24){
                                    c.setPosition(-0.6, -0.3, -3.2);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 25){
                                    c.setPosition(-0.4, -0.3, -2.0);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 26){
                                    c.setPosition(2.2, -0.3, -3.5);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 27){
                                    c.setPosition(0.8, -0.3, -3.5);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 28){
                                    c.setPosition(2.3, -0.3, -2.2);
                                    c.setRotation(0.0, 20.0, 5.0);
                                } else if (x == 29){
                                    c.setPosition(1.0, -0.3, -2.1);
                                    c.setRotation(0.0, 20.0, 5.0);
                                }
