...
/**
 * Created by smartwavedev on 5/30/16.
 */
public class FelicisimaViewerFragment extends BaseViewerFragment implements View.OnTouchListener {

    public static String TAG = "FelicisimaViewerFragment";
    private ArrayList<String> selectedColor = new ArrayList<>();
    public static FelicisimaViewerFragment INSTANCE = null;
...
//            getCurrentScene().addChild(debugViz);
            ...
            LoaderOBJ  objParser = new LoaderOBJ(mContext.getResources(), mTextureManager, R.raw.felicisima_obj);;
            ...
            try {
                ...
                for(int x=0; x<49; x++) {
                    ...
                    if (x == 1){ /* 1st row */
                        ...
                        c.setPosition(2.4, -0.1, 1.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 3){
                        c.setPosition(3.2, -0.1, 1.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 4){
                        c.setPosition(4.0, -0.1, 1.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 5){
                        c.setPosition(4.8, -0.1, 1.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 6){
                        c.setPosition(5.6, -0.1, 1.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 7){
                        c.setPosition(0.7, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 8){
                        c.setPosition(0.7, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 9){
                        c.setPosition(0.7, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 10){
                        c.setPosition(0.7, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 11){
                        c.setPosition(0.7, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 12){
                        c.setPosition(0.7, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 13){
                        c.setPosition(1.6, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 14){
                        c.setPosition(2.4, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 15){
                        c.setPosition(3.2, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 16){
                        c.setPosition(4.0, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 17){
                        c.setPosition(4.8, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 18){
                        c.setPosition(5.6, -0.1, 0.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 19){
                        c.setPosition(1.6, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 20){
                        c.setPosition(2.4, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 21){
                        c.setPosition(3.2, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 22){
                        c.setPosition(4.0, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 23){
                        c.setPosition(4.8, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 24){
                        c.setPosition(5.6, -0.1, -0.6);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 25){
                        c.setPosition(1.6, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 26){
                        c.setPosition(2.4, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 27){
                        c.setPosition(3.2, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 28){
                        c.setPosition(4.0, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 29){
                        c.setPosition(4.8, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 30){
                        c.setPosition(5.6, -0.1, -1.5);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 31){
                        c.setPosition(1.6, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 32){
                        c.setPosition(2.4, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 33){
                        c.setPosition(3.2, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 34){
                        c.setPosition(4.0, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 35){
                        c.setPosition(4.8, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 36){
                        c.setPosition(5.6, -0.1, -2.3);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 37){
                        c.setPosition(1.6, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 38){
                        c.setPosition(2.4, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 39){
                        c.setPosition(3.2, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 40){
                        c.setPosition(4.0, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 41){
                        c.setPosition(4.8, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 42){
                        c.setPosition(5.6, -0.1, -3.2);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 43){
                        c.setPosition(1.6, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 44){
                        c.setPosition(2.4, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 45){
                        c.setPosition(3.2, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 46){
                        c.setPosition(4.0, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 47){
                        c.setPosition(4.8, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    } else if (x == 48){
                        c.setPosition(5.6, -0.1, -4.0);
                        c.setRotation(0.0, 20.0, 5.0);
                    }
